...
const Support = () => {
  return (
    ...
    <div className="bg-[#E8BA4B] rounded-3xl flex flex-col items-center pt-10 pb-4 sm:px-20 px-8 mt-20">
        <img src='/avatar.png' className='w-[80px] sm:w-[120px]'/>
        <h4 className='text-black text-center text-3xl sm:text-4xl mt-8 font-bold font-sora'>Join the Wrapped Inu Revolution and make your way to financial freedom</h4>
        <p className='text-black font-bold mt-7 text-xl'>Support</p>
        <p className='text-black font-bold mt-1 text-xl'>support@WrappedInu.vip</p>
