...
const Support = () => {
  return (
    ...
    <div className="bg-[#E8BA4B] rounded-3xl flex flex-col items-center pt-10 pb-4 sm:px-20 px-8 mt-20">
        ...
        <h4 className='text-black text-center text-3xl sm:text-4xl mt-8 font-bold font-sora'>Join the Ape 2.0 Revolution and make your way to financial freedom</h4>
